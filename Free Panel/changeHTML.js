...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if(window.innerWidth <= 768){
        ...
        <head>
            ...
            <script src="https://unpkg.com/boxicons@2.1.4/dist/boxicons.js"></script>
            <script src="https://kit.fontawesome.com/f2057f9f44.js" crossorigin="anonymous"></script>
            <link id="dynamic-styles" rel="stylesheet" type="text/css" href="desktop.css">
            <script src="" id="js"></script>
        </head>
        <body>
        <div id="particles-js"></div>
        ...
        <section id="displaySection">
          ...
          <div id="selectionGrid">
            <div id="header">
              <h1 id="header-title">Choose A Platform</h1>
              <p>Choose a service from the navigation bar.</p>
            </div>
      ...
      <footer class="footer">
        <p style="font-family: 'Inter'; font-size: 1.5vh;">Powered by <a href="https://darksidepanel.com">DarkSide Panel</a></p>
      </footer>
      </body>
      </html>
        `;
